...
<? else: ?>
	<div class="row">
		<div class="span8">
			<h3>
				Jobs Pending QA
				:: 1-<?= min(10, $qa_count) ?> of <?= $qa_count ?> :: <a href="<?= $queue->getUrl() ?>/jobs/qa">see
					all</a>
			</h3>
			...
			<h3>
				Working Jobs
				:: 1-<?= min(10, $taken_count) ?> of <?= $taken_count ?> :: <a
					href="<?= $queue->getUrl() ?>/jobs/taken">see all</a>
			</h3>
			...
			<h3>
				Available Jobs
				:: 1-<?= min(10, $available_count) ?> of <?= $available_count ?> :: <a
					href="<?= $queue->getUrl() ?>/jobs/available">see all</a>
			</h3>
			...
			<h3>
				Completed Jobs
				:: 1-<?= min(10, $complete_count) ?> of <?= $complete_count ?> :: <a
					href="<?= $queue->getUrl() ?>/jobs/complete">see all</a>
			</h3>
			...
			<table class="table table-striped table-bordered table-condensed">
				...
				<tr>
					...
					<td><span
						...
						(<?= round($stats['available_pct'], 2) ?>%)
					</td>
				</tr>
				<tr>
					<th>Taken Jobs</th>
					<td><span
							class="label <?= JobStatus::getStatusHTMLClass('taken') ?>"><?= (int)$stats['taken'] ?></span>
						(<?= round($stats['taken_pct'], 2) ?>%)
					</td>
				</tr>
				<tr>
					<th>Complete Jobs</th>
