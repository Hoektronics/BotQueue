	...
	<div id="DashtronController">
		...
		<form class="form-inline pull-right muted">
			...
			<select id="dashboard_style" onchange="loadDashtron()">
				<option value="large_thumbnails" <?php echo ($style == 'large_thumbnails') ? 'selected' : '' ?>>Large
					Thumbnails
				</option>
				<option value="medium_thumbnails" <?php echo ($style == 'medium_thumbnails') ? 'selected' : '' ?>>Medium
					Thumbnails
				</option>
				<option value="small_thumbnails" <?php echo ($style == 'small_thumbnails') ? 'selected' : '' ?>>Small
					Thumbnails
				</option>
				<option value="list" <?php echo ($style == 'list') ? 'selected' : '' ?>>Detailed List</option>
			</select>
		</form>
