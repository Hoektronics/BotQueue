	...
	<div id="DashtronController">
		...
		<form class="form-inline pull-right muted">
			...
			<select id="dashboard_style" onchange="loadDashtron()">
				<option value="large_thumbnails" <?= ($style == 'large_thumbnails') ? 'selected' : '' ?>>Large
					Thumbnails
				</option>
				<option value="medium_thumbnails" <?= ($style == 'medium_thumbnails') ? 'selected' : '' ?>>Medium
					Thumbnails
				</option>
				<option value="small_thumbnails" <?= ($style == 'small_thumbnails') ? 'selected' : '' ?>>Small
					Thumbnails
				</option>
