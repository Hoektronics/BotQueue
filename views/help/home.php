<div class="alert">
  <strong>Warning!</strong> This website and software are ALPHA and should be consider experimental.  You have been warned.
</div>

<h2>Important: only tested on Mac and Linux so far.  Windows status is questionable.  Testers wanted!</h2>
...
<p>There will be official releases in the future, but for now you should pull down the <a href="">git repository</a>.</p>
