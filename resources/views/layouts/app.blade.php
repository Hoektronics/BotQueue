...
<body>
<nav class="flex border-b border-gray-400 mb-4">
    <div class="flex-none my-auto ml-4">
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 202 249" height="3rem">
            <a href="/">
    ...
    <div class="flex-grow justify-between flex p-4">
