...
our $alien_key = 'gtk2_2_9_3_uni_gcc_3_4';

{
    my $VAR1;
    $Wx::dlls = $VAR1 = {
          'richtext' => 'libwx_gtk2u_richtext-2.9.so',
          'core' => 'libwx_gtk2u_core-2.9.so',
          'gl' => 'libwx_gtk2u_gl-2.9.so',
          'net' => 'libwx_baseu_net-2.9.so',
          'html' => 'libwx_gtk2u_html-2.9.so',
          'media' => 'libwx_gtk2u_media-2.9.so',
          'xml' => 'libwx_baseu_xml-2.9.so',
          'animate' => 'libwx_gtk2u_animate-2.9.so',
          'xrc' => 'libwx_gtk2u_xrc-2.9.so',
          'base' => 'libwx_baseu-2.9.so',
          'aui' => 'libwx_gtk2u_aui-2.9.so',
          'fl' => 'libwx_gtk2u_fl-2.9.so',
          'stc' => 'libwx_gtk2u_stc-2.9.so',
          'gizmos' => 'libwx_gtk2u_gizmos-2.9.so',
          'qa' => 'libwx_gtk2u_qa-2.9.so',
          'webview' => 'libwx_gtk2u_webview-2.9.so',
          'propgrid' => 'libwx_gtk2u_propgrid-2.9.so',
          'adv' => 'libwx_gtk2u_adv-2.9.so',
          'ribbon' => 'libwx_gtk2u_ribbon-2.9.so'
        };
;
}

$VERSION = '0.9906'; # bootstrap will catch wrong versions
$XS_VERSION = $VERSION;
...
sub _alien_path {
  ...
  return unless length 'gtk_2_9_3_uni';
  foreach ( @INC ) {
    if( -d "$_/Alien/wxWidgets/gtk_2_9_3_uni" ) {
      $wx_path = "$_/Alien/wxWidgets/gtk_2_9_3_uni/lib";
      last;
    }
  }
}
